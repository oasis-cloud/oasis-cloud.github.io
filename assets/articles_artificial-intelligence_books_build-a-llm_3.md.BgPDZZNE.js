...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#24292E;"># True的位置保留原值</span></span></code></pre></div><p><img src="`+p+'" alt="img.png"></p><h3 id="多头注意力机制" tabindex="-1">多头注意力机制</h3><p>多头注意力的主要思想是并行运行注意力机制，每次使用学到的不同的线性投影（将输入数据乘以权重矩阵得到的）。</p><p>多头注意力的结果表示为一个张量，例如两个注意力头会生成一个张量，该张量包含两个上下文向量矩阵。</p>',26)])])}const o=i(e,[["render",t]]);export{E as __pageData,o as default};
